...
public class URCtrl extends BaseCtrl{
	...
	public ModelAndView getUsers(String page, String size, String deptId) {
		...
		Long count = this.userSrv.Count(deptId);
		List<User> data = this.userSrv.getByDeptCode(pageIndex, pageSize,deptId);
