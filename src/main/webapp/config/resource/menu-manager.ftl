...
<div class="row">
	<div class="col-md-12" style="background-color: #fff; height: 44px; line-height: 44px; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
		<i style="font-size: 20px; margin: 0 10px;">菜单资源管理</i> <span>
...
<div class="menu-tree" style="position: absolute; left: 0px; right: 0px; bottom: 0; overflow: auto; top: 43px;">加载中......</div>
